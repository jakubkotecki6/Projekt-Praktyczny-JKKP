...
public final class ProductService {
    ...
    public static void generateProductsList() {
        ...
        try (Writer writer = new FileWriter("ProductsDB.JSON")) {
            ...
            System.err.println("Wystąpił błąd podczas zapisywania listy produktów " + e.getMessage());
        }
    }
    ...
    public void loadProductsFromFile() {
        try (Reader reader = new FileReader("ProductsDB.JSON")) {
            ...
            System.err.println("Wystąpił błąd podczas odczytywania pliku listy produktów " + e.getMessage());
        }
    }
